...
def main():
    if rank == 0:
        ...
        path_to_gal_dir = directory_hodsmith + '/output/1600/run2_linkinglengths/0p3mps/cat_snapshot_observed.hdf5'
        hodDict = readFile(path_to_gal_dir)
        path_to_halo_dir = '/home/shivani.shah/Projects/LIGO/runs/Round8/run2_linkinglengths/0p3mps/output'
        simCat = readSimCat(path_to_halo_dir)
        print("Collected everything")
    else:
        hodDict = None
    ...
    if rank == 0:
        ...
        filePath = "../data/1600/run2_linkinglengths/0p3mps/mock_cat0.hdf5"
